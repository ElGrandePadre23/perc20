...
async function main() {
  ...
  const replace_contractAddress = "0xd8D7cFd81489C3aA13264Ac38f48De37d575ad46";

  // Get the signer (your account)
  const [signer] = await hre.ethers.getSigners();

  // Create a contract instance
  const replace_contractFactory = await hre.ethers.getContractFactory("SwissTronikPerc20");
